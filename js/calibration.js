...
$(document).ready(function(){
  ...
  $('.Calibration').click(function(){ // click event on the calibration buttons
    ...
    if (CalibrationPoints[id]==N_clickEachBtn){ //only turn to yellow after 5 clicks
      $(this).css('background-color','yellow');
      $(this).prop('disabled', true); //disables the button
      PointCalibrate++;
    }else if (CalibrationPoints[id]<N_clickEachBtn){
      //Gradually increase the opacity of calibration points when click to give some indication to user.
      var opacity = (1.0/N_clickEachBtn)*CalibrationPoints[id]+(1.0/N_clickEachBtn);
...
function ClearCalibration(){
  ...
  $(".Calibration").css('opacity',1.0/N_clickEachBtn);
